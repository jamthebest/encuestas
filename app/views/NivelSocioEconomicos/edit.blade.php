...
<div class="page-header clearfix">
    <h3 class="pull-left">Niveles Socio Económicos <small> &gt; Editar Nivel Socio Económico</small></h3>
...
{{ Form::model($NivelSocioEconomico, array('method' => 'PATCH', 'route' => array('NivelSocioEconomicos.update', $NivelSocioEconomico->id), 'class' => "form-horizontal" , 'role' => 'form')) }}
