...
<div class="page-header clearfix">
    <h3 class="pull-left">Precios <small> &gt; Editar Precio</small></h3>
...
{{ Form::model($Precio, array('method' => 'PATCH', 'route' => array('Precios.update', $Precio->id), 'class' => "form-horizontal" , 'role' => 'form')) }}
